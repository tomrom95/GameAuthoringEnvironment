...
public class LevelEditorView implements Glyph {
    ...
    // TODO
    private IEntryView myNumberEnemy = new TextEntryView(myNumberEnemyKey, myData, 150, 30,
                                                         AuthoringView.DEFAULT_ENTRYVIEW);
    private IEntryView myRate = new TextEntryView(myRateKey, myData, 150, 30,
                                                  AuthoringView.DEFAULT_ENTRYVIEW);
    private IEntryView myWinCondition = new TextEntryView(myWinConditionKey, myData, 150, 30,
                                                          AuthoringView.DEFAULT_ENTRYVIEW);
    private IEntryView myLoseCondition = new TextEntryView(myLoseConditionKey, myData, 150, 30,
                                                           AuthoringView.DEFAULT_ENTRYVIEW);
