 ...
 * properly
 * 
 * The only part that is necessary now is the {@link #getGridHeight()} and the {@link #getGridWidth()}
 * functionality as that will allow for proper screen edge checking and will assist with some internal
